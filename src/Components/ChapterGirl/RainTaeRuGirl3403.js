...
const Dialog17 = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      dispatch({ type: "index/RTRGIRL_3413" });
    }, 1000);
  }, [dispatch]);
  return (
    <div className="forFade_g">
      ...
      <button
        className="c2girlnextBtn0"
        onClick={() => {
          dispatch({ type: "index/CKGIRL_3404" });
        }}
      >
        다음
      </button>
...
const Dialog18 = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      dispatch({ type: "index/RTRGIRL_3423" });
    }, 1000);
  }, [dispatch]);
  return (
    <div className="forFade_g">
...
export default RainTaeRuGirl3403;
