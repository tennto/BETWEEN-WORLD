...
import GSound5in2 from "../Girlmusic/GSound5in2";
import GSound5in1 from "../Girlmusic/GSound5in1";
...
const Dialog10 = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      dispatch({ type: "index/CKGIRL_1405" });
    }, 1000);
  }, [dispatch]);
  return (
    <>
      <h3 className="dialog_oneline">아...아..</h3>
    </>
  );
};

export default SnowManGirl;
